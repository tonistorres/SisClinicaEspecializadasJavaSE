...
//TELA USUARIO 
//******************
import static br.com.multclin.telas.TelaUsuario.cbPerfilUsuarios;
import static br.com.multclin.telas.TelaUsuario.lblFonePreferencial;
import static br.com.multclin.telas.TelaUsuario.txtCPF;
import static br.com.multclin.telas.TelaUsuario.txtIDUsuario;
import static br.com.multclin.telas.TelaUsuario.txtUsuario;
 ...
 * @author DaTorres
 */
public class SubTelaFone extends javax.swing.JInternalFrame {
     ...
     */
    private static SubTelaFone instance = null;

    public static SubTelaFone getInstance() {

        if (instance == null) {

            instance = new SubTelaFone();
    ...
    public void validacoesTelaUsuario() {
        ...
        if (estaFechado(formUsuario)) {
            ...
            //informação 
            JOptionPane.showMessageDialog(this, "" + "\n Informação:\n"
                    + "Cadastro Usuario Fechado."
                    + "", "Mensagem Informativa", 0, new ImageIcon(getClass().getResource("/br/com/multclin/imagens/info.png")));
        }

    }

    public void validacoesTelaPaciente() {
    ...
    private void aoCarregarForm() {
        ...
        btnBuscaPaisRegiao.setEnabled(false);
    ...
    private void personalizacaoFrontEnd() {
        ...
        btnBuscaPaisRegiao.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/botoes/forms/linkForms.png")));
    ...
    private void initComponents() {
        ...
        btnBuscaPaisRegiao = new javax.swing.JButton();
        ...
        btnBuscaPaisRegiao.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnBuscaPaisRegiaoActionPerformed(evt);
            }
        });
        painelDadosCapturados.add(btnBuscaPaisRegiao, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 70, 30, 30));
            ...
            if (value instanceof JButton) {
                ...
                if (boton.getName().equalsIgnoreCase("Ed")) {
                    ...
                    try {
                        ...
                        if (retorno.getPerfilDto().equals("ANALISTA")
                                || retorno.getPerfilDto().equals("ADMIN")
                                || retorno.getPerfilDto().equals("USER1")
                                || retorno.getPerfilDto().equals("USER2")) {
                            ...
                            JOptionPane.showMessageDialog(this, ""
                                    ...
                                    + "a partir do Cadastro de Celulares/Usuário.\n"
                                    + "", "Mensagem Informativa", 0, new ImageIcon(getClass().getResource("/br/com/multclin/imagens/info.png")));
...
//        gerarCodigoGUIeDataSistema();
         ...
         */
        lblIDFone.setText(txtIDUsuario.getText());
        this.txtCelular.setEnabled(true);
        this.btnBuscaPaisRegiao.setEnabled(true);
    ...
    private void btnBuscaPaisRegiaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscaPaisRegiaoActionPerformed
        if (estaFechado(formListaPaisRegiao)) {
            formListaPaisRegiao = new FrmListaPaisRegiao();
            DeskTop.add(formListaPaisRegiao).setLocation(5, 3);
            formListaPaisRegiao.setTitle("Lista de Países e Região");
            formListaPaisRegiao.setVisible(true);
        } else {
            formListaPaisRegiao.toFront();
            formListaPaisRegiao.setVisible(true);

        }
    }//GEN-LAST:event_btnBuscaPaisRegiaoActionPerformed
    ...
    private javax.swing.JButton btnBuscaPaisRegiao;
