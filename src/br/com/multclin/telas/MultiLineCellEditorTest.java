...
public class MultiLineCellEditorTest {
    ...
    String[] columnNames = {"id", "Orientação","DR(A)",""};//colunas 
    Object[][] data = {
      {String.valueOf(1), "Medicação tomada pelo paciente no dia hidroclorotiazida furosemida ","Kelly"},
    ...
    //aqui começa o uso de textAreal
