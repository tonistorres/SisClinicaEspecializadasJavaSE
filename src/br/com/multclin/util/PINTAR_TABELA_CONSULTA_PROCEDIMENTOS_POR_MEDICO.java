 ...
 * @author X552E
 */
public class PINTAR_TABELA_CONSULTA_PROCEDIMENTOS_POR_MEDICO extends DefaultTableCellRenderer {
//*************************************************************************
...
//criamos o construtor 
    public PINTAR_TABELA_CONSULTA_PROCEDIMENTOS_POR_MEDICO() {
    }
    ...
    public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
        ...
        boolean retorno = exiteNaTabela(table, obj, 1);
...
//agora vamos pinta o fundo da tabela 
    ...
    public boolean exiteNaTabela(JTable tabela, String obj, int col) {
