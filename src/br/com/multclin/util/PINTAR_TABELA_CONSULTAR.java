 ...
 * @author X552E
 */
public class PINTAR_TABELA_CONSULTAR extends DefaultTableCellRenderer {
//*************************************************************************
...
//criamos o construtor 
    public PINTAR_TABELA_CONSULTAR() {
    }
    ...
    public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
        ...
        Object objeto = table.getValueAt(row, 4);
        ...
        try {
            ...
            Date dataAgendada = formatador.parse(objeto.toString());
            Date dataAtual = formatador.parse(lblStatusData.getText());
            //converter uma String para Calendar
            Calendar dataNoFormatoCalendar = formatador.getCalendar();
            dataNoFormatoCalendar.setTime(dataAgendada);//date
            dataNoFormatoCalendar.setTime(dataAtual);//date

            //PINTANDO SETORES INTERNOS DO PROTOCOLO 
            if (dataAgendada.getTime() < dataAtual.getTime()) {
